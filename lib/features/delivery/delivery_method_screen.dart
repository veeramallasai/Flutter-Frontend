...
class _DeliveryMethodScreenState extends State<DeliveryMethodScreen> {
  ...
  bool get _isShopMode =>
      widget.initialShoppingMode.trim().toLowerCase() == 'shop';
      ...
      appBar: AppBar(
        title: const Column(
          ...
          children: <Widget>[
            ...
            Text(
              'Freshness timed around your day',
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          _DeliveryChoice(
            ...
            description:
                _isShopMode
                    ? 'Planned bulk delivery with careful handling.'
                    : 'Pick a convenient window and skip the rush.',
          ...
          _DeliveryChoice(
            ...
            description:
                'Reserve produce closer to harvest for peak freshness.',
      ...
      children: <Widget>[
        ...
        Expanded(
          child: Column(
            ...
            children: <Widget>[
              Text(
                _isShopMode ? 'Business-ready logistics' : 'Delivered your way',
              ...
              const Text(
                'Every order is quality checked, sealed and trackable.',
                style: TextStyle(
                  color: Color(0xFFD1EFDE),
                  fontSize: 10,
                  height: 1.4,
    ...
    child: InkWell(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(23),
          border: Border.all(
            color: selected ? AppColors.primary : const Color(0xFFE2EAE6),
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Icon(
                  ...
                  color: selected ? AppColors.primary : const Color(0xFFB9C3BE),
                  size: 22,
                ),
              ],
            ),
...
class _OrderSnapshot extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(20),
      border: Border.all(color: const Color(0xFFF1E4B5)),
    ),
    child: Row(
      children: <Widget>[
