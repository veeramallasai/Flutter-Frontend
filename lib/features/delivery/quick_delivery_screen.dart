    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          QuickDeliveryCard(isSelected: true, onTap: () {}, fee: deliveryFee),
          ...
          const _Feature(
            ...
            subtitle:
                'Products are picked and packed after order confirmation.',
          ),
          const SizedBox(height: 10),
          const _Feature(
        ...
        Expanded(
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 5),
              Text(
                'Priority picked, quality checked and delivered in 30–60 minutes.',
                style: TextStyle(
